  ...
  return (
    <div className="w-full space-y-4 md:space-y-8 py-[80px] md:py-[40px] px-[40px] animation-effect">
      <div className="text-left mb-[60px] md:mt-[70px] animation-effect">
        <h1 className="text-[48px] font-bold text-gray-900">Login</h1>
        <p className="mt-2 text-gray-600">Please login to your account first</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-6">
        ...
        <div>
          <button
            type="submit"
            className="flex w-full justify-center rounded-lg bg-[#E35D33] py-3 px-4 text-sm font-medium text-white shadow-sm hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-[#E35D33] focus:ring-offset-2 cursor-pointer"
          >
            Login
          </button>
        </div>
