 ...
 * @Last Modified time: 2025-03-24 21:25:52
 */
    ...
    return (
        <div className=" bg-[#F9F9F9] border-[1px] border-[#E0E0E0] rounded-[16px] flex justify-between items-center py-[8px] px-[8px] md:px-[16px] animation-effect">
            <div className="flex items-center gap-[16px]">
                <img src={data.img} alt="man" className="w-[40px] h-[40px] md:w-[52px] md:h-[52px] rounded-[8px] md:rounded-[16px] animation-effect"/>
                <div className="flex flex-col gap-[4px]">
                    <span className="text-[12px] md:text-[14px] font-bold animation-effect">{data.name}</span>
                    <span className="text-[10px] md:text-[12px] text-[#E35D33] font-bold animation-effect">{data.desc}</span>
                </div>
            </div>
