 ...
 * @Last Modified time: 2025-04-19 20:49:34
 */
"use client"
        ...
        <Link href={data.link} target="_blank" rel="noopener noreferrer" className="w-full">
            <div className=" bg-[#F9F9F9] border-[1px] border-[#E0E0E0] rounded-[16px] flex justify-between items-center py-[8px] px-[8px] md:px-[16px] animation-effect">
                <div className="flex items-center gap-[16px]">
                    <img src={data.img} alt="img" className="w-[60px] md:w-[108px] md:h-[61px] rounded-[8px] animation-effect"/>
                    <div className="flex flex-col gap-[4px]">
                        ...
                        <div className="flex md:flex-row items-center gap-[8px]">
                            <button className="whitespace-nowrap flex justify-center items-center rounded-[6px] bg-[#E35D33] text-[10px] font-bold text-[#FFF] py-[6px] px-[8px]">
                                <img src='/assets/calendar.svg' alt='calendar' className='w-[12px] h-[12px] mr-[4px]'/>
                                {data.date}
                            </button>
                            <button className="whitespace-nowrap flex justify-center items-center rounded-[6px] bg-[#1E419D] text-[10px] font-bold text-[#FFF] py-[6px] px-[8px]">
