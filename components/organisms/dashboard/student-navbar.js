 ...
 export default function StudentNavbar() {
    ...
    return (
        <div className="lingo-container flex flex-col h-full pt-[80px] sm:pt-[103.61px]">
                ...
                <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center w-full h-full gap-[20px] lg:gap-0 animation-effect">
                    <div className="flex items-center gap-[23px]">
                        ...
                        <div className="flex flex-col gap-[6px] md:gap-[14px]">
                            {loading ? 
                                <div className='rounded-md bg-gray-300 animate-pulse text-transparent text-[18px] md:text-[24px]'>{user?.sub}</div>
                            : 
                                <span className="font-semibold text-[18px] md:text-[24px] animation-effect">{user?.sub}</span>
                            }
            ...
            <div className="overflow-x-auto mb-[40px] pt-[15px] md:pt-[20px] px-[20px] md:px-[40px] w-full h-[50px] md:h-[65px] border-[1px] border-[#FF723A40] border-t-0 flex items-center">
