...
export default function ReviewWarningModal({ isOpen, onClose, onContinueReview }) {
                ...
                <div className="p-6">
                    ...
                    <div className="mb-6">
                        <p className="text-gray-600">
                            All review must be completed before download certificate
                        </p>
                    </div>
                    ...
                    <div className="flex space-x-4">
                        ...
                        <button
                            ...
                            className="flex-1 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500"
                        >
                            Continue Review
                        </button>
                    </div>
